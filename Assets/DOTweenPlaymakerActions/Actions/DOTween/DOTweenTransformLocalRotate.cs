        ...
        public override void OnEnter()
        {
            switch (target)
            {
                ...
                case Doozy.PlayMaker.Actions.Target.GameObject:
                    tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOLocalRotate(toGameObject.Value.transform.localEulerAngles, duration.Value, rotateMode);
                    break;
            }
